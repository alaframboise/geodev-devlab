...
Before you start you need to sign up for a *free* developer account if you don't already have one. This will give you the ability to store maps, layers and data in the cloud and use the [ArcGIS Premium Services](https://developers.arcgis.com/pricing/credits/).
